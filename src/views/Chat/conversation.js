...
import ChatIcon from "../../assets/images/logo/chat.png";
            ...
            <CCard className="friendcard">
              <div className="d-flex align-items-center p-2">
                ...
                <div className="col-xl-7 col-lg-7 col-md-7 col-sm-5">
                  {chat.histroyListData.type === "personal" ? (
                    <>
                    ...
                    <>
                      <div className="font-weight-bold">
                        {chat.histroyListData.name}
                      </div>
                      <div className="message-font-size">
                        {chat.histroyListData.total_members}
                      </div>
                    </>
                  )}
                </div>
