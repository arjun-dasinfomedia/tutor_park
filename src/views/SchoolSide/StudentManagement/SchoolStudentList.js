...
import { syllabusListData } from 'src/redux/actions/dropdowns';
import { Autocomplete } from "@mui/material";
import { State, City } from "country-state-city";
import { TextField } from "@material-ui/core";
import moment from "moment";
import SchoolStudentEdit from "./EditSchoolStudent"
...
const SchoolStudentList = () => {
    ...
    // initial value for new add school student
    ...
    const validate = (fieldValues = values) => {
        ...
        if ("class_id" in fieldValues)
            temp.class_id = fieldValues.class_id ? "" : "Please select a Class field."

        if ("syllabus_id" in fieldValues)
            temp.syllabus_id = fieldValues.syllabus_id ? "" : "Please select a Syllabus field."

        if ("section_id" in fieldValues)
            temp.section_id = fieldValues.section_id ? "" : "Please select a Section field."
    ...
    const handleSubmit = (e) => {
        ...
        if (validate()) {
            ...
            data.append('role', "school-student")
            ...
            data.append("school_class_id", values.class_id);
            data.append("school_class_division_id", values.section_id);
    ...
    useEffect(async () => {
        showLoader();
        await dispatch(schoolStudentList({ role: "school-student" }));
    ...
    useLayoutEffect(() => {
        if (values.syllabus_id === "") {
        }
        else {
            dispatch(schoolClassBySyllabus({ syllabus_id: values.syllabus_id }))
        }

        if (values.class_id === "") {
        }
        else {
            dispatch(schoolDivisionByClass({ class_id: values.class_id }))
        }
    })

    // view Student list column
    const columns = [
        {
            title: "Tp Id",
                ...
                <div>
                    <CRow className="p-3">
                        <CCol xl={12} sm={12} className="card-title font-weight-bold">
                            ...
                            {
                                checkAccessPermission('user_add') ? <><CButton
                    ...
                    <div className="p-3 text-center">
                        <MaterialTable
                            title=""
                            data={SchoolStudent.schoolStudentData}
                            columns={columns}
                            options={{
                                ...
                                <CRow>
                                    ...
                                    <CCol xl={6} sm={6} className="">
                                        <Controls.Select
                                            ...
                                            options={SchoolStudent.schoolClassList}
                                            onChange={handleInputChange}
                                ...
                                <CRow>
                                    <CCol xl={6} sm={6} className="">
                                        <Controls.Select
                                            ...
                                            options={SchoolStudent.schoolDivisionList}
                                            onChange={handleInputChange}
                                ...
                                <CRow>
                                    <CCol sm={12} md={12} lg={6} xl={6} className="m-2">
                                        <div className="d-inline">
                                            <Controls.Button type="submit" text="Add Student" className="m-1" />
                                        </div>
                                        <div className="d-inline">
                                            <Controls.Button
                                                className="m-1"
                    ...
                    <CModal visible={viewUserModal} size="lg" onDismiss={() => setViewUserModal(false)}>
                        ...
                        <CModalBody>
                            ...
                            {viewUserData && viewUserData.role_name === "school-student" ?
                    ...
                    {SchoolStudent.userEditStatus !== false ? (
                        <CModal
                        ...
                        >
                            ...
                            <CModalBody>
                                <SchoolStudentEdit data={editUserData} />
                            </CModalBody>
                        </CModal>
