...
const Network = (props) => {
	...
	const pageCount = Math.ceil(friend.friendListData.length / PER_PAGE);
					...
					<CCard bodyWrapper className="p-3 friendcard mt-3 mb-3">
						<div className="row user-image-center">
							...
							<div className="myfriend-text-center col-12 col-sm-12 col-md-8 col-lg-8 col-xl-8 text-sm-center text-sm-center text-md-start text-lg-start text-xl-start ">
								<div className="col">
									<h5 className="d-inline card-title font-weight-bold">{item.name}</h5>
									<div className="d-inline m-2 simple-normal-font">{item.city}</div>
								</div>
								<div className="col medium-text">{item.email}</div>
								<div className="col medium-text">{item.description}</div>
								<div className="col">
			...
			{isLoading ? (
				...
				loadfriendlistDynamic.length !== 0 ? (
					<div>
						...
						{friend.friendListData.length > 10 ? (
						...
						<CModal visible={viewvisible} size="xl" onDismiss={() => setViewVisible(false)}>
							<CModalHeader onDismiss={() => setViewVisible(false)} className="tutorviewmodalheader">
								...
								<div className="row p-3 justify-content-around text-wrap ">
									...
									<div className="border tuitionimage my-2 col-12 col-sm-12 col-md-8 col-lg-8 col-xl-8">
										<div className="row border viewmodalcolor font-weight-bold viewmodalcoursedaetail" >
											<CCardHeader style={{ fontSize: 18 }} className="text-dark card-title">
												Network Details
											</CCardHeader>
										</div>
										<div className="p-3">
											<div className="row ">
												...
												<div className="col-8">
													{friend.viewUserData.first_name} {friend.viewUserData.last_name}
												</div>
											</div>
											<div className="row">
												<div className="col-4 font-weight-bold">
												...
												<div className="col-8">
													{friend.viewUserData.user_details !== undefined ? friend.viewUserData.user_details.city : ''}
												</div>
											</div>
											<div className="row">
												<div className="col-4 font-weight-bold">
												...
												<div className="col-8">
													{friend.viewUserData.user_details !== undefined ? friend.viewUserData.user_details.state : ''}
												</div>
											</div>
											<div className="row">
												<div className="col-4 font-weight-bold">
												...
												<div className="col-8">
													{friend.viewUserData.user_details !== undefined && friend.viewUserData.user_details.phone !== null ? friend.viewUserData.user_details.phone : 'N/A'}
												</div>
											</div>
											<div className="row">
												<div className="col-4 font-weight-bold">
						...
						<CModal visible={messagevisible} onDismiss={() => setMessageVisible(false)}>
							<CModalHeader onDismiss={() => setMessageVisible(false)} className="tutorviewmodalheader">
					...
					<NoDataContainer module="Network" />
				)}
		</div>
	);
}
