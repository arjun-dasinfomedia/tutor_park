...
const AssignmentList = (prop) => {
  ...
  const pageCount = Math.ceil(
    assignmentState.assignmentList.pending_assignments &&
      assignmentState.assignmentList.pending_assignments.length / PER_PAGE
  );
                ...
                <CCol>
                  <CCard className="card p-3 assigncard mt-3 mb-3">
                    <div className="row">
                              ...
                              {checkAccessPermission("assignment_edit") ? (
                                <div className="carddetailfooter normal-font">
                                  ...
                                  >
                                    ...
                                    >
                                      <CButton className="btn m-1 sessionbutton">
                                        Attempt
                                      </CButton>
                                    </Link>
                                  </CTooltip>
                      ...
                      {/* icon button */}
                      <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-3 d-flex justify-content-center align-items-center"></div>
                    </div>
                  </CCard>
                </CCol>
              </div>
  ...
  return (
    <>
      ...
      <div>
        {isLoading ? (
          <>{loader}</>
        ) : assignmentState.assignmentList.pending_assignments !== undefined &&
          assignmentState.assignmentList.pending_assignments !== null ? (
          <>
            {StudentAssignData}
            <div className="mt-4 col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 d-flex justify-content-center text-center">
              {assignmentState.assignmentList.pending_assignments.length >
              10 ? (
                <ReactPaginate
                  previousLabel={"<<"}
                  nextLabel={">>"}
