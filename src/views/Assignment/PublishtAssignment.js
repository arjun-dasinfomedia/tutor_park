...
import { faSearch, faEye, faCircle } from "@fortawesome/free-solid-svg-icons";
...
const AssignmentList = (prop) => {
  ...
  const pageCount = Math.ceil(
    assignmentState.assignmentList.published_assignments &&
      assignmentState.assignmentList.published_assignments.length / PER_PAGE
  );
                            ...
                            <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              ...
                              <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <div className="carddetailfooter normal-font">
                                  ...
                                  >
                                    <CButton
                                      ...
                                      onClick={() =>
                                        listNotAttemptedAssignment(item.id)
                                      }
                                    >
                                      Not Attempted
                                    </CButton>
                                ...
                                <div className="font-weight-bold">
                                  Total Attempted:-{item.total_attempted}
                                </div>
                              </div>
                            </div>
                          </div>
              ...
              <div className="text-center col-12">
                <div className="postsearchheader">
                  ...
                  <Link to="/add-assignment" className="text-decoration-none">
                    <CButton className="d-inline textbook-add-button-css w-auto ">
                      Create Assignment
                    </CButton>
                  </Link>
                </div>
        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="mt-4 col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 d-flex justify-content-center text-center">
              {assignmentState.assignmentList.published_assignments.length >
              10 ? (
                <ReactPaginate
                  previousLabel={"<<"}
                  nextLabel={">>"}
