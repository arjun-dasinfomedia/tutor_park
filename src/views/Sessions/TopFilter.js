import { CCard, CButton, CFormInput } from "@coreui/react";
...
const TopFilter = () => {
  ...
  return (
    <>
      {checkAccessPermission("tuition_session_view") ? (
        <>
          <CustomAlertControl />
              ...
              <div className="col-12">
                ...
                <div className="mt-2 row">
                  ...
                  <div className="col-10 col-sm-10 col-md-6 col-lg-6 col-xl-6 d-flex position-relative text-center">
                    <CFormInput
                      onChange={(event) =>
                        setUpcomingSession(event.target.value)
                      }
